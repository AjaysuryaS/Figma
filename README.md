...
<body>
    <div style="width: 100%; height: 100%; justify-content: flex-start; align-items: flex-start; gap: 48px; display: inline-flex">
        <div style="width: 360px; height: 640px; position: relative; background: white">
            <div style="width: 300px; height: 37px; left: 47px; top: 23px; position: absolute; text-align: center; color: black; font-size: 20px; font-family: Inter; font-weight: 400; word-wrap: break-word">Saveetha Engineering College</div>
            ...
            <img style="width: 92px; height: 88px; left: 20px; top: 100px; position: absolute" src="https://via.placeholder.com/92x88" />
        ...
        <div style="width: 343px; height: 640px; position: relative; background: white">
...
```
## OUTPUT:
![image](https://github.com/AjaysuryaS/Figma/assets/114158396/9578b257-26bf-4afb-9c53-4e266adfa0b0)
